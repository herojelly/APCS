...
public class MrKuszmaul implements Person {
	...
	// The jacket is an example of polymorphism. It has type
	// Jacket but is an instance of KevlarJacket.
	private Jacket jacket = new KevlarJacket();
	...
	/**
	 * Mr. Kuszmaul zips his jacket. This is an
	 * example of delegation, delegating the job
	 * of zipping the jacket to the Jacket class.
	 */
	...
	/**
	 * Mr. Kuszmaul unzips his jacket. This is another
